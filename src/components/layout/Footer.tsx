        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              />
              <span className="text-2xl font-bold text-white">Ygente</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/embajadores" className="text-gray-400 hover:text-white transition-colors">
                  {nav('embajadores')}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/circulo-fundador" className="text-gray-400 hover:text-white transition-colors">
                  {nav('circuloFundador')}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            {/* Social */}
            <h4 className="font-semibold mb-4 mt-8">{t('social')}</h4>
