...
export function Header() {
  ...
  const navItems: NavEntry[] = [
    ...
    { href: '/marcas', label: t('marcas') },
    {
      label: t('ygente'),
      children: [
        { href: '/ygente', label: t('ygente') },
        { href: '/ygente/vision', label: t('ygVision') },
        { href: '/ygente/como-funciona', label: t('ygWorks') },
        { href: '/ygente/principios', label: t('ygPrinciples') },
        { href: '/ygente/liderazgo', label: t('ygLeadership') },
        { href: '/ygente/mercados', label: t('ygMarkets') },
        { href: '/ygente/socio-regional', label: t('ygRegionalPartner') },
